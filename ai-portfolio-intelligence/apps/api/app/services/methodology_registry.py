...
DEFAULT_METHODOLOGIES: tuple[MethodologyRecord, ...] = (
    ...
    MethodologyRecord(
        ...
        independent_validation_fixture="tests/fixtures/tax/us_fifo_wash.json",
        known_limitations=(
            "Personal-use after golden fixtures; worksheets still require professional review before filing.",
        ),
    ...
    MethodologyRecord(
        ...
        known_limitations=(
            "Approved for personal use after golden fixtures; scenario assumptions remain user-owned.",
        ),
    ...
    MethodologyRecord(
        ...
        owner="valuation",
        approval_status="approved_for_personal_use",
        independent_validation_fixture="tests/fixtures/valuation/bank_residual_income.json",
        known_limitations=(
            "Approved for personal use after golden fixtures; residual-income ROE normalization is user-owned.",
        ),
        rollback_version="0.0.0",
    ),
    MethodologyRecord(
        ...
        owner="valuation",
        approval_status="approved_for_personal_use",
        independent_validation_fixture="tests/fixtures/valuation/reit_nav_affo.json",
        known_limitations=(
            "Approved for personal use after golden fixtures; NAV/AFFO blend weights are illustrative.",
        ),
        rollback_version="0.0.0",
    ),
    MethodologyRecord(
        ...
        owner="valuation",
        approval_status="approved_for_personal_use",
        independent_validation_fixture="tests/fixtures/valuation/utility_rate_base.json",
        known_limitations=(
            "Approved for personal use after golden fixtures; regulatory lag and payout assumptions are user-owned.",
        ),
        rollback_version="0.0.0",
    ),
    MethodologyRecord(
        methodology_id="options_american_pricer",
        name="American Options CRR Pricer",
        version="1.0.0",
        effective_date=date(2026, 7, 20),
        owner="derivatives-analytics",
        approval_status="approved_for_personal_use",
        independent_validation_fixture="tests/fixtures/options/american_put.json",
        known_limitations=(
            "Personal-use CRR binomial; discrete dividends and early-exercise barriers remain simplified.",
        ),
        rollback_version=None,
    ),
    MethodologyRecord(
        methodology_id="options_margin_regt",
        name="Equity Options Reg T Margin",
        version="1.0.0",
        effective_date=date(2026, 7, 20),
        owner="derivatives-analytics",
        approval_status="approved_for_personal_use",
        independent_validation_fixture="tests/fixtures/options/regt_short_put.json",
        known_limitations=(
            "Reg T style estimates only; IBKR Portfolio Margin (TIMS) can differ materially.",
        ),
        rollback_version=None,
    ),
    MethodologyRecord(
