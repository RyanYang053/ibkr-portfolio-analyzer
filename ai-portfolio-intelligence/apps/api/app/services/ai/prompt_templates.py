...
def build_stock_analysis_prompt(*, position: Position, score: Any, recommendation: Any) -> str:
    ...
    payload["output_schema"] = {
        ...
        "decision_id": "string",
        "authoritative_outcome": "data_insufficient | monitor | review_thesis | review_add | review_trim | review_exit",
        "score_interpretation": "high_heuristic_score | supportive_score | mixed_score | weak_score | high_risk_score | data_insufficient",
        "rule_engine_action": "evidence only — mirror authoritative_outcome",
        "action": "must equal authoritative_outcome action label; AI must not invent Strong Add/Buy/Sell",
        "add_zone": "string",
        "hold_zone": "string",
